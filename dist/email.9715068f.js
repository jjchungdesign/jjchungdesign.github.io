...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/email.js":[function(require,module,exports) {
var modal = document.getElementById('email-modal');
var openBtn = document.querySelector('.main-btn');
var closeBtn = document.querySelector('.close-btn'); // Click Events
...
var message = document.getElementById('message'); // Show error message

function showError(input, message) {
  var formValidation = input.parentElement;
  formValidation.className = 'form-validation error';
  var errorMessage = formValidation.querySelector('p');
