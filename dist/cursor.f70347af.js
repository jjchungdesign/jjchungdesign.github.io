...
var circleType = new CircleType(document.getElementById("rotated")).dir(-1); //Hover Selector

var $hoverables = document.querySelectorAll('#hoverable');
var ball = document.querySelector(".cursor-text");
var pos = {
...
gsap.ticker.add(function () {
  var dt = 1 - Math.pow(1.0 - speed, gsap.ticker.deltaRatio());
...
var spincursor = new TimelineMax({
  repeat: -1
});
